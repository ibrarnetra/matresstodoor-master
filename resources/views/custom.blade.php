...
<html>
   ...
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('/')}}custom/places/style.css" />
      <script src="{{asset('/')}}custom/places/index.js"></script>
   </head>
  ...
  Not recommended for user-facing forms due to risk of mis-click when aiming for Submit button. -->
      ...
      <script src="https://maps.googleapis.com/maps/api/js?key={{getConstant('GOOGLE_MAP_API')}}&callback=initAutocomplete&libraries=places&v=weekly" async></script>
   </body>
