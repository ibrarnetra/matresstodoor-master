                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        <div class="card-toolbar">
                            @can('Add-Roles')
                            <a href="{{route('roles.create')}}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle"></i> Create New</a>
                            @endcan
                        </div>
                    </div>
                    <!--end::Header-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="table-responsive">
                            <!--begin::Table-->
                            <table id="data_table" class="table table-striped table-sm gy-2 gs-2 align-middle">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$role->name}}</td>
                                        <td>
                                            <a href="javascript:void(0);" class="badge badge-light-primary" onclick="loadModal('{{route('roles.show', ['id'=>$role->id])}}')" data-bs-toggle="tooltip"
                                        ...
                                        <td class="text-end">
                                            @can('Edit-Roles')
                                            <a href="{{route('roles.edit', ['id' => $role->id])}}" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-bs-toggle="tooltip"
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-icon btn-active-light-primary w-30px h-30px"
                                                onclick="deleteData('{{route('roles.delete', ['id' => $role->id])}}', false)" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark"
