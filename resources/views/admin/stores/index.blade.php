                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        <div class="card-toolbar">
                            @can('Add-Stores')
                            <a href="{{route('stores.create')}}" class="btn btn-sm btn-primary create"><i class="fas fa-plus-circle"></i> Create New</a>
                            @endcan
                            {{-- <a href="javascript:void(0);" class="btn btn-sm btn-danger delete d-none" onclick="bulkDelete('{{route('stores.bulkDelete')}}')"><i class="fas fa-trash-alt"></i>
                            Delete</a> --}}
                        </div>
                    </div>
                    <!--end::Header-->
                    ...
                    <div class="card-body pt-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" class="badge badge-light-{{$store->status == " 1" ? "success" : "danger"}}" data-bs-toggle="tooltip"
                                                        ...
                                                        onclick="updateStatus('{{route('stores.update-status', ['id' => $store->id])}}', '{{$store->status}}', false)">
                                                        {{$store->status == "1" ? "Active" : "Inactive"}}
                                                    </a>
                                                </td>
                                                <td>
                                                    @can('Edit-Settings')
                                                    <a href="{{route('stores.edit', ['id' => $store->id])}}" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-bs-toggle="tooltip"
                                                    ...
                                                    onclick="deleteData('{{route('stores.delete', ['id' => $store->id])}}', false)" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {{$stores->links('admin.pagination.pagination')}}
                            </div>
                        </div>
                    </div>
                </div>
