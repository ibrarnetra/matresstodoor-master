        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <!--end::Header-->
                    <!--begin::Body-->
                    <form method="POST" enctype="multipart/form-data" @if($type=="create" ) action="{{route('manufacturers.store')}}" @else action="{{route('manufacturers.update', ['id' => $id])}}"
                        @endif>
                                ...
                                <div class="tab-pane active" id="general" role="tabpanel">
                                    <div class="row mt-8">
                                        ...
                                        <div class="mb-5 col-md-4">
                                            ...
                                            <img class="img-fluid" width="80" src="{{asset('storage/manufacturer_images/'.$modal['image'])}}" alt="{{$modal['image']}}">
                                        </div>
                                        @endif
                                    </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12 text-start">
                                    ...
                                    <a class="btn btn-secondary" href="{{route('manufacturers.index')}}">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
