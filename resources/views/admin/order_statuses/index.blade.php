                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input delete-checkbox" type="checkbox" name="id" value="{{$order_status->id}}" />
                                            </div>
                                        </td>
                                        <!--end::Checkbox-->
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="badge badge-light-{{$order_status->status == "1" ? "success" : "danger"}}" data-bs-toggle="tooltip"
                                                data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="{{$order_status->status == "1" ? "Active" : "Inactive"}}"
                                                onclick="updateStatus('{{route('order-statuses.update-status', ['id' => $order_status->id])}}', '{{$order_status->status}}', false)">
                                                {{$order_status->status == "1" ? "Active" : "Inactive"}}
                                            </a>
                                        </td>
