                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        <div class="card-toolbar">
                            @can('Add-Products')
                            <a href="{{route('products.create')}}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle"></i> Create New</a>
                            @endcan
                        </div>
                    </div>
                    <!--end::Header-->
...
<script>
    $(document).ready(function () {
        ...
        let configOptions = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function( data, type, full, meta ) {
                        if(data === null || data === undefined || data === ""){
                            ...
                            return "<img width=\"35\" width=\"35\" src=\"{{asset('storage/product_images/thumbnail/')}}/" + data + "\" alt=\"" + data + "\" />";
                        }
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function( data, type, full, meta ) {
                        if(data.discount !== 0){
                            return "<span class=\"badge badge-light-primary\"  title=\"Original Price\" style=\"text-decoration: line-through;\">"+ "$" + setDefaultPriceFormat(data.price) +"</span> <span class=\"badge badge-light-warning\" title=\"Discounted Price\">" + "$"+ setDefaultPriceFormat(data.price - data.discount) + "</span>";
                        } else {
                            return "<span class=\"badge badge-light-primary\" title=\"Original Price\" >"+ "$" + setDefaultPriceFormat(data.price) +"</span>";
                        }
                    }
                },
                {
        ...
        initDataTable(element, configOptions);
    });
</script>
@endpush