                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        <div class="card-toolbar">
                            @can('Add-Attributes')
                            <a href="{{route('attributes.create')}}" class="btn btn-sm btn-primary create"><i class="fas fa-plus-circle"></i> Create New</a>
                            @endcan
                            <a href="javascript:void(0);" class="btn btn-sm btn-danger delete d-none" onclick="bulkDelete('{{route('attributes.bulkDelete')}}')"><i class="fas fa-trash-alt"></i>
                                Delete</a>
                        </div>
                    </div>
                    <!--end::Header-->
                            ...
                            <table id="generic-datatable" class="table table-striped table-sm gy-2 gs-2 align-middle">
                                <thead>
                                    <tr class="fw-bolder fs-6 text-gray-800">
                                        ...
                                        <th style="width: 30%">Attribute Group</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$attribute->attribute_group->eng_description->name}}</td>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="badge badge-light-{{$attribute->status == " 1" ? "success" : "danger"}}" data-bs-toggle="tooltip"
                                                ...
                                                onclick="updateStatus('{{route('attributes.update-status', ['id' => $attribute->id])}}', '{{$attribute->status}}', false)">
                                                {{$attribute->status == "1" ? "Active" : "Inactive"}}
                                            </a>
                                        </td>
                                        <td>
                                            @can('Edit-Attributes')
                                            <a href="{{route('attributes.edit', ['id' => $attribute->id])}}" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-bs-toggle="tooltip"
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-icon btn-active-light-primary w-30px h-30px"
                                                onclick="deleteData('{{route('attributes.delete', ['id' => $attribute->id])}}', false)" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark"
