                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        <div class="card-toolbar">
                            @can('Add-Categories')
                            <a href="{{route('categories.create')}}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle"></i> Create New</a>
                            @endcan
                        </div>
                    </div>
                    <!--end::Header-->
                ...
                },
                {
                    ...
                    render: function( data, type, full, meta ) {
                        if(data === null || data === undefined || data === ""){
                            ...
                            return "<img width=\"35\" width=\"35\" src=\"{{asset('storage/category_images/150x150/')}}/" + data + "\"  alt=\"" + data + "\" />";
                        }
                    }
                },
                { 
