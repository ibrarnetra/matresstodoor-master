      ...
      <div class="row">
         <div class="col-md-12">
            <div class="card mb-5 mb-xl-8">
               ...
               <!--end::Header-->
               <!--begin::Body-->
               <form method="POST" action="{{route('users.assignUnassignTeamLead')}}" autocomplete="off">
                  <div class="card-body pt-0">
                     ...
                     <div class="row">
                        <div class="col-md-4 mb-5">
                           ...
                           <input type="text" class="form-control form-control-solid @error('name') is-invalid @enderror" id="name" autocomplete="off" readonly
                              value="{{ old('name') ?: ($modal->first_name ." ". $modal->last_name)}}" />
                           @error('name')
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-3 mb-4">
                                 <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" name="team_members[]" value="{{$user->id}}" id="team-members-{{$user->id}}" @if (in_array($user->id,
                                    $team_members)) checked @endif >
                                    <label class="form-check-label" for="team-members-{{$user->id}}">
