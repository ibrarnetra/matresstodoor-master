        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-1 mb-5 pb-3 pt-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{route('warehouses.create')}}" class="btn btn-sm btn-primary create"><i class="fas fa-plus-circle"></i> Create New</a>
                    @endcan
                    <a href="javascript:void(0);" class="btn btn-sm btn-danger delete d-none" onclick="bulkDelete('{{route('warehouses.bulkDelete')}}')"><i class="fas fa-trash-alt"></i>
                        Delete</a>
                </div>
            </div>
            <!--end::Header-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input delete-checkbox" type="checkbox" name="id" value="{{$warehouse->id}}" />
                                    </div>
                                </td>
                                <!--end::Checkbox-->
                                ...
                                <td>{{$warehouse->email_no}}</td>
                                <td>{{$warehouse->address}}</td>
    
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-light btn-active-light-primary btn-sm dropdown-toggle" type="button" id="{{$warehouse->id}}" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            Action
                                        </button>
                                        <ul class="dropdown-menu" aria-labelledby="{{$warehouse->id}}">
                                            @can('Edit-Manufacturers')
                                            <a href="{{route('warehouses.edit', ['id' => $warehouse->id])}}" class="dropdown-item">
                                                Edit
                                            </a>
                                            @endcan
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item" onclick="deleteData('{{route('warehouses.delete', ['id' => $warehouse->id])}}', false)">
                                                Delete
                                            </a>
                                            @endcan
                                        </ul>
