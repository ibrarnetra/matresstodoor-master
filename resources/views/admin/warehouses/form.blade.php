        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <!--end::Header-->
                    <!--begin::Body-->
                    <form method="POST" enctype="multipart/form-data" @if($type=="create" ) action="{{route('warehouses.store')}}" @else action="{{route('warehouses.update', ['id' => $id])}}"
                        @endif>
                            ...
                            <div class="tab-content tabcontent-border mt-3">
                                <div class="tab-pane active" id="general" role="tabpanel">
                                    <div class="row mt-8">
                                        ...
                                        <div class="mb-5 col-md-6">
                                            <label for="name" class="form-label required">Phone No</label>
                                            <input type="text" class="form-control form-control-solid @error('contact_no') is-invalid @enderror" id="contact_no" name="contact_no" required @if($type=="create" )
                                                value="{{ old('contact_no') }}" @else value="{{ old('contact_no') ?: $modal['contact_no'] }}" @endif>
                                    ...
                                    <div class="row">
                                        <div class="mb-5 col-md-6">
                                            <label for="email_no" class="form-label">Email</label>
                                            <input type="email" class="form-control form-control-solid @error('email_no') is-invalid @enderror" id="email_no" name="email_no"
                                                @if($type=="create" ) value="{{ old('email_no') }}" @else value="{{ old('email_no') ?: $modal['email_no'] }}" @endif>
                                        ...
                                        <div class="mb-5 col-md-6">
                                            ...
                                            <input type="text" class="form-control form-control-solid @error('address') is-invalid @enderror" id="address" name="address"
                                                @if($type=="create" ) value="{{ old('address') }}" @else value="{{ old('address') ?: $modal['address'] }}" @endif>
