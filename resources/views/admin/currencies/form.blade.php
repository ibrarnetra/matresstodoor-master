        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <!--end::Header-->
                    <!--begin::Body-->
                    <form method="POST" enctype="multipart/form-data" @if($type=="create" ) action="{{route('currencies.store')}}" @else action="{{route('currencies.update', ['id' => $id])}}" @endif>
                        <div class="card-body pt-0">
                            ...
                            <div class="row">
                                <div class="mb-5 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" class="form-control form-control-solid @error('title') is-invalid @enderror" id="title" name="title" required @if($type=="create"
                                ...
                                <div class="mb-5 col-md-6">
                                    ...
                                    <input type="text" maxlength="3" class="form-control form-control-solid @error('code') is-invalid @enderror" id="code" name="code" required @if($type=="create" )
                                        value="{{ old('code') }}" @else value="{{ old('code') ?: $modal->code }}" @endif>
                            ...
                            <div class="row">
                                <div class="mb-5 col-md-6">
                                    ...
                                    <input type="text" maxlength="3" class="form-control form-control-solid @error('symbol_left') is-invalid @enderror" id="symbol_left" name="symbol_left"
                                        @if($type=="create" ) value="{{ old('symbol_left') }}" @else value="{{ old('symbol_left') ?: $modal->symbol_left }}" @endif>
                                ...
                                <div class="mb-5 col-md-6">
                                    ...
                                    <input type="text" maxlength="3" class="form-control form-control-solid @error('symbol_right') is-invalid @enderror" id="symbol_right" name="symbol_right"
                                        @if($type=="create" ) value="{{ old('symbol_right') }}" @else value="{{ old('symbol_right') ?: $modal->symbol_right }}" @endif>
                            ...
                            <div class="row">
                                <div class="mb-5 col-md-6">
                                    <label class="form-label" for="decimal_place">Decimal Place</label>
                                    <input type="number" class="form-control form-control-solid @error('decimal_place') is-invalid @enderror" id="decimal_place" name="decimal_place"
                                        @if($type=="create" ) value="{{ old('decimal_place') }}" @else value="{{ old('decimal_place') ?: $modal->decimal_place }}" @endif>
                                ...
                                <div class="mb-5 col-md-6">
                                    ...
                                    <input type="number" step="0.01" class="form-control form-control-solid @error('value') is-invalid @enderror" id="value" name="value" @if($type=="create" )
                                        value="{{ old('value') }}" @else value="{{ old('value') ?: $modal->value }}" @endif>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12 text-start">
                                    ...
                                    <a class="btn btn-secondary" href="{{route('currencies.index')}}">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
