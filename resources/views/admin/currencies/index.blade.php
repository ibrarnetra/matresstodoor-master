                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        <div class="card-toolbar">
                            @can('Add-Currencies')
                            <a href="{{route('currencies.create')}}" class="btn btn-sm btn-primary create"><i class="fas fa-plus-circle"></i> Create New</a>
                            @endcan
                            {{-- <a href="javascript:void(0);" class="btn btn-sm btn-danger delete d-none" onclick="bulkDelete('{{route('currencies.bulkDelete')}}')"><i class="fas fa-trash-alt"></i>
                            Delete</a> --}}
                        </div>
                    ...
                    <div class="card-body pt-0">
                                            ...
                                            <tr class="fw-bolder fs-6 text-gray-800">
                                                <th style="width: 5%;">
                                                    <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                        <input class="form-check-input delete-checkbox" type="checkbox" data-kt-check="true"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                        <input class="form-check-input delete-checkbox" type="checkbox" name="id" value="{{$currency->id}}" />
                                                    </div>
                                                </td>
                                                <!--end::Checkbox-->
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" class="badge badge-light-{{$currency->status == " 1" ? "success" : "danger"}}" data-bs-toggle="tooltip"
                                                        data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="{{$currency->status == " 1" ? "Active" : "Inactive"}}"
                                                        onclick="updateStatus('{{route('currencies.update-status', ['id' => $currency->id])}}', '{{$currency->status}}', false)">
                                                        {{$currency->status == "1" ? "Active" : "Inactive"}}
                                                    </a>
                                                </td>
                                                <td>
                                                    @can('Edit-Currencies')
                                                    <a href="{{route('currencies.edit', ['id' => $currency->id])}}" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-bs-toggle="tooltip"
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-active-light-primary w-30px h-30px"
                                                        onclick="deleteData('{{route('currencies.delete', ['id' => $currency->id])}}', false)" data-bs-toggle="tooltip"
                        ...
                        {{-- <div class="row">
                            <div class="col-md-12">
                                {{ $currencies->links('admin.pagination.pagination') }}
                    </div>
                </div> --}}
            </div>
        </div>
