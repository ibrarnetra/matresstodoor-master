                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        {{-- <div class="card-toolbar">
                            @can('Add-Languages')
                            <a href="{{route('languages.create')}}" class="btn btn-sm btn-primary create"><i class="fas fa-plus-circle"></i> Create New</a>
                        @endcan
                        <a href="javascript:void(0);" class="btn btn-sm btn-danger delete d-none" onclick="bulkDelete('{{route('languages.bulkDelete')}}')"><i class="fas fa-trash-alt"></i>
                            Delete</a>
                    </div> --}}
                </div>
                <!--end::Header-->
                        ...
                        <table id="generic-datatable" class="table table-striped table-sm gy-5 gs-7">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$language->name}}</td>
                                    <td>
                                        <a href="javascript:void(0);" class="badge badge-light-{{$language->status == " 1" ? "success" : "danger"}}" data-bs-toggle="tooltip"
                                            data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="{{$language->status == " 1" ? "Active" : "Inactive"}}">
