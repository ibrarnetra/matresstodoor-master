                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        {{-- <div class="card-toolbar">
                            @can('Add-Reviews')
                            <a href="{{route('reviews.create')}}" class="btn btn-sm btn-primary create"><i class="fas fa-plus-circle"></i> Create New</a>
                        @endcan
                        <a href="javascript:void(0);" class="btn btn-sm btn-danger delete d-none" onclick="bulkDelete('{{route('reviews.bulkDelete')}}')"><i class="fas fa-trash-alt"></i>
                            Delete</a>
                    </div> --}}
                </div>
                <!--end::Header-->
