        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        {{-- <div class="card-toolbar">
                            @can('Add-Countries')
                            <a href="{{route('countries.create')}}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle"></i> Create New</a>
                        @endcan
                    </div> --}}
                </div>
                <!--end::Header-->
                ...
                <div class="card-body pt-0">
                                ...
                                <table id="generic-datatable" class="table table-striped table-sm gy-2 gs-2 align-middle">
                                    <thead>
                                        <tr class="fw-bolder fs-6 text-gray-800">
                                            ...
                                            <th style="width: 10%">ISO Code 2</th>
                                            <th style="width: 10%">ISO Code 3</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            {{$countries->links('admin.pagination.pagination')}}
                        </div>
                    </div>
                </div>
            </div>
