                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            @endif
                            {{-- <a href="{{route('orders.exportExcel')}}" class="btn btn-success btn-sm me-2" id="export"><i class="fas fa-file-export"></i> Export Order</a> --}}
                            @can('Add-Purchases')
                            <a href="{{route('purchases.create')}}" class="btn btn-primary btn-sm me-2"><i class="fas fa-plus-circle"></i> Create Purchase</a>
                            @endcan
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control form-control-sm custom-date-picker" id="from" placeholder="Purchase From" aria-label="Purchase From" autocomplete="off">
                                            <span class="input-group-text">-</span>
                                            <input type="text" class="form-control form-control-sm custom-date-picker" id="to" placeholder="Purchase To" aria-label="Purchase To" autocomplete="off">
                                        </div>
                                    </div>
                                ...
                                <table id="generic-datatable" class="table table-striped row-border order-column table-sm gy-2 gs-2 align-middle">
                                    <thead>
                                        <tr class="fw-bolder fs-6 text-gray-800">
                                            ...
                                            <th class="min-w-100px">Purchase #</th>
                                            <th class="min-w-300px">Warehouse</th>
                                            <th class="min-w-150px">Serial No</th>
...
<script>
    ...
    function setConfigOptions() {
        ...
        let teamMemberId = $("#team-member option:selected").val() !== undefined && $("#team-member option:selected").val() !== '' ? $("#team-member option:selected").val():'-1';
        ...
        // SET EXPORT URL
        $("#export").attr("href", '{{route("orders.exportExcel")}}' + "?date_range=" + dateRange  + "&sales_rep_id=" + saleRepId + "&warehouse_id=" + warehouseId );
        @if (Auth::guard('web')->user()->hasRole("Super Admin") || 
        Auth::guard('web')->user()->hasRole("Office Admin") ||
        Auth::guard('web')->user()->hasRole("Dispatch Manager"))
        @endif
        ...
        return {
            ...
            columns: [
                ...
                // {
                //     data: "purchase_total_payable_amount",
                //     name: "purchase_total_payable_amount",
                //     orderable: false,
                //     searchable: false,
