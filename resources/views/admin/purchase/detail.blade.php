...
<div class="toolbar" id="kt_toolbar">
   ...
   <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
      ...
      <div class="d-flex align-items-center py-1">
         @can('Read-Purchases')
         <a href="{{route('purchases.generateInvoice', ['id' => $id])}}" target="_blank" class="btn btn-success btn-sm me-2">
            <i class="far fa-file-alt"></i> Generate Invoice
         </a>
         @endcan
         @can('Edit-Purchases')
         <a href="{{route('purchases.edit', ['id' => $id])}}" class="btn btn-warning btn-sm me-2">
            <i class="far fa-edit"></i> Edit Purchase
         </a>
         @endcan
         @can('Add-Purchases')
         <a href="{{route('purchases.create')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle"></i> Create New</a>
         @endcan
      </div>
   </div>
   <!--end::Container-->
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="card">
                     <div class="card-header border-1">
                        <h3 class="card-title">
                           <span class="card-label fw-bolder fs-3"><i class="fas fa-shopping-cart"></i> &nbsp;Purchase Details</span>
                        </h3>
                     </div>
               
                     <div class="card-body">
                        @if (isset($purchase->warehouse->name) && $purchase->warehouse->name != "" && !is_null($purchase->warehouse->name))
                        <p class="card-text"><i class="fas fa-store-alt"></i>
                           &nbsp; <span data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="WareHouse">{{$purchase->warehouse->name}}</span></p>
                        @endif
                        <p class="card-text"><i class="fas fa-calendar-alt"></i>
                           &nbsp; <span data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Purchase Date">{{date(getConstant('DATE_FORMAT'), strtotime($purchase->created_at))}}</span>
                        </p>
                      
                        <p class="card-text"><i class="far fa-credit-card"></i>
                           &nbsp; <span data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Serial No">{{$purchase->serial_no}}
                              </span></p>
                       
                        @if ($purchase->vehicle_no)
                        <p class="card-text"><i class="fas fa-truck"></i>
                           &nbsp; <span data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Vehicle No">{{$purchase->vehicle_no}}
                             </span></p>
                        @endif
                     </div>
                  </div>
               ...
               <div class="col-md-6">
                  <div class="card">
                     <div class="card-header border-1">
                        <h3 class="card-title">
                           <span class="card-label fw-bolder fs-3"><i class="fas fa-user"></i> &nbsp;WareHouse Details</span>
                        </h3>
                     </div>

                     <div class="card-body">
                        <p class="card-text"><i class="fas fa-user"></i> &nbsp;
                           <span data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Warehouse">
                              {{$purchase->warehouse->name}}
                           </span>
                        </p>
                        <p class="card-text"><i class="fas fa-envelope"></i>
                           &nbsp; <span data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Email">{{$purchase->warehouse->email}}</span></p>
                        <p class="card-text"><i class="fas fa-phone-alt"></i>
                           &nbsp; <span data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Telephone">{{$purchase->warehouse->contact_no}}</span></p>
                     </div>
                  </div>
               </div>
            ...
            <div class="row mt-5">
               <div class="col-md-12">
                  <div class="card">
                     <div class="card-header border-1">
                        <h3 class="card-title">
                           <span class="card-label fw-bolder fs-3"><i class="fas fa-info-circle"></i> &nbsp;{{$purchase->invoice_no}}</span>
                        </h3>
                     </div>
                        ...
                        <div class="row mt-5">
                           <div class="col-md-12">
                              <div class="table-responsive">
                                 <table class="table table-sm table-row-bordered table-column-bordered table-row-gray-300 border gs-3 gy-3">
                                    <thead>
                                       <tr class="fw-bolder fs-6 text-gray-800">
                                          <th colspan="2" style="width: 70%;">Product</th>
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          <td colspan="2" class="fw-bolder fs-6 text-gray-800 text-end">Purchase Date</td>
                                       ...
                                       <tr>
                                          <td colspan="3" class="fs-6 text-gray-800 text-start"><span class="fw-bolder">Remarks:</span> @if ($purchase->remarks)
                                             {{$purchase->remarks}}
                                             @else
                                             N/A
                                             @endif
