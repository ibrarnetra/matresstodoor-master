    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                <!--begin::Logo-->
                <a href="{{ route('admin.signIn') }}" class="mb-12">
                    <img alt="Logo" src="{{ asset('metronic/') }}/media/misc/logo.jpg" class="h-90px" />
                </a>
                <!--end::Logo-->
                <!--begin::Wrapper-->
                <div class="w-lg-500px bg-white rounded shadow-lg p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST"
                        action="{{ route('admin.auth') }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <input
                                ...
                                minlength="8" type="password" name="password" value="{{ old('password') }}" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-10">
                            ...
                            <div class="d-flex flex-stack mb-2">
                                <!--begin::Label-->
                                <label class="form-label fw-bolder text-dark fs-6 mb-0 required">Store</label>
                                <!--end::Label-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Input-->
                            <select
                                class="form-select form-select-solid form-select-lg @error('store_id') is-invalid @enderror"
                        ...
                        <div class="text-center">
                            ...
                            <button type="submit" class="btn btn-lg btn-primary w-100 mb-5">
                                <span class="indicator-label">Sign in <i class="fas fa-long-arrow-alt-right"></i></span>
                            </button>
                            <!--end::Submit button-->
                        </div>
                        <!--end::Actions-->
