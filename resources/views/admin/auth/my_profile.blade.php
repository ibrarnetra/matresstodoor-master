      ...
      <div class="row">
         <div class="col-md-12">
            <div class="card mb-5 mb-xl-8">
               ...
               <!--end::Header-->
               <!--begin::Body-->
               <form method="POST" action="{{route('admin.handleProfileUpdate')}}" autocomplete="off">
                  <div class="card-body pt-0">
                     ...
                     <div class="row">
                        <div class="col-md-4 mb-5">
                           ...
                           <input type="text" class="form-control form-control-solid @error('first_name') is-invalid @enderror" name="first_name" id="first_name" placeholder="First Name"
                              autocomplete="off" required value="{{ old('first_name') ?: Auth::user()->first_name}}">
                           @error('first_name')
                        ...
                        <div class="col-md-4 mb-5">
                           ...
                           <input type="text" class="form-control form-control-solid @error('last_name') is-invalid @enderror" name="last_name" id="last_name" placeholder="Last Name"
                              autocomplete="off" required value="{{ old('last_name') ?: Auth::user()->last_name}}">
                           @error('last_name')
                           <div class="invalid-feedback">
                              {{ $message }}
                           </div>
                        ...
                        <div class="col-md-4 mb-5">
                           ...
                           <input type="tel" class="form-control form-control-solid @error('telephone') is-invalid @enderror" name="telephone" id="telephone" placeholder="xxx-xxx-xxxx"
                              pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" autocomplete="off" value="{{ old('telephone') ?: Auth::user()->telephone}}">
                           @error('telephone')
                           <div class="invalid-feedback">
                              {{ $message }}
                           </div>
                     ...
                     <div class="row">
                        <div class="col-md-6 mb-5">
                           ...
                           <input type="email" class="form-control form-control-solid @error('email') is-invalid @enderror" id="email" placeholder="Email" autocomplete="off" readonly
                        ...
                        <div class="col-md-6 mb-5">
                           ...
                           <input type="role" class="form-control form-control-solid @error('role') is-invalid @enderror" id="role" placeholder="role" autocomplete="off" readonly
                     ...
                     <div class="row">
                        <div class="col-md-4 mb-5">
                           ...
                           <select class="form-select form-select-solid country" aria-label="country_id" name="country_id" id="country_id" onchange="getZones(this, '{{route('zones.getZones')}}')"
                              style="width: 100%;">
                              <option value="" selected disabled>-- Select Country --</option>
                              @if (count($countries) > 0)
                              @foreach ($countries as $country)
                              <option value="{{$country->id}}" @if (Auth::user()->country_id == $country->id)
                                 selected
                        ...
                        <div class="col-md-4 mb-5">
                           ...
                           <select class="form-select form-select-solid zone" aria-label="state_id" name="state_id" id="state_id" style="width: 100%;">
                              ...
                              <option value="{{$zone->id}}" @if (Auth::user()->state_id == $zone->id)
                                 selected
                     ...
                     <div class="row">
                        <div class="col-md-4 mb-5">
                           ...
                           <input type="text" class="form-control form-control-solid @error('zip_code') is-invalid @enderror" name="zip_code" id="zip_code" placeholder="Zip Code" autocomplete="off"
                        ...
                        <div class="col-md-8 mb-5">
                           ...
                           <textarea type="text" class="form-control form-control-solid @error('address') is-invalid @enderror" name="address" id="address" placeholder="Address"
                              autocomplete="off">{{ old('address') ?: Auth::user()->address}}</textarea>
                           @error('address')
                           <div class="invalid-feedback">
                              {{ $message }}
                           </div>
