        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <!--end::Header-->
                    <!--begin::Body-->
                    <form method="POST" enctype="multipart/form-data" @if($type=="create" ) action="{{route('length-classes.store')}}" @else action="{{route('length-classes.update', ['id' => $id])}}"
                        @endif>
                        <div class="card-body pt-0">
                                ...
                                <div class="tab-pane" id="{{$language->code}}" role="tabpanel">
                                    <div class="row mt-8">
                                        <div class="mb-5 col-md-6">
                                            <label class="form-label required" for="length_class_description[{{$language->code}}][title]">Title</label>
                                            <input type="text" maxlength="32" class="form-control form-control-solid @error('length_class_description.'.$language->code.'.title') is-invalid @enderror"
                                                id="length_class_description[{{$language->code}}][title]" name="length_class_description[{{$language->code}}][title]" required @if($type=="create" )
                                                value="{{ old('length_class_description.'.$language->code.'.title') }}" @else
                                                value="{{ old('length_class_description.'.$language->code.'.title') ?: $modal['length_class_description'][''.$language->code.'']['title'] }}" @endif>

                                            @error('length_class_description.'.$language->code.'.title')
                                        ...
                                        <div class="mb-5 col-md-6">
                                            <label class="form-label required" for="length_class_description[{{$language->code}}][unit]">Unit</label>
                                            <input type="text" maxlength="4" class="form-control form-control-solid @error('length_class_description.'.$language->code.'.unit') is-invalid @enderror"
                                                id="length_class_description[{{$language->code}}][unit]" name="length_class_description[{{$language->code}}][unit]" required @if($type=="create" )
                                                value="{{ old('length_class_description.'.$language->code.'.unit') }}" @else
                                                value="{{ old('length_class_description.'.$language->code.'.unit') ?: $modal['length_class_description'][''.$language->code.'']['unit'] }}" @endif>

                                            @error('length_class_description.'.$language->code.'.unit')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                            @enderror
                            ...
                            <div class="row">
                                <div class="mb-5 col-md-6">
                                    ...
                                    <input type="number" step="0.00001" min="0" class="form-control form-control-solid @error('value') is-invalid @enderror" id="value" name="value" required
                                        @if($type=="create" ) value="{{ old('value') }}" @else value="{{ old('value') ?: $modal['value'] }}" @endif>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12 text-start">
                                    ...
                                    <a class="btn btn-secondary" href="{{route('length-classes.index')}}">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
