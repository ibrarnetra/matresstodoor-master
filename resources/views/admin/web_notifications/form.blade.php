        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <!--end::Header-->
                    <!--begin::Body-->
                    <form method="POST" enctype="multipart/form-data" @if($type=="create" ) action="{{route('web-notifications.store')}}" @else
                        action="{{route('web-notifications.update', ['id' => $id])}}" @endif>
                        <div class="card-body pt-0">
                            ...
                            <div class="row">
                                <div class="mb-5 col-md-12">
                                    <label class="form-label required" for="notification">Notification</label>
                                    <textarea type="text" class="form-control form-control-solid @error('notification') is-invalid @enderror" id="notification"
                                        name="notification">@if($type=="create" ){{ old('notification') }}@else{{ old('notification') ?: $modal->notification }}@endif</textarea>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12 text-start">
                                    ...
                                    <a class="btn btn-secondary" href="{{route('web-notifications.index')}}">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
