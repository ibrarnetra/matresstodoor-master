                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        <div class="card-toolbar">
                            @can('Add-Sliders')
                            <a href="{{route('sliders.create')}}" class="btn btn-sm btn-primary create"><i class="fas fa-plus-circle"></i> Create New</a>
                            @endcan
                            {{-- <a href="javascript:void(0);" class="btn btn-sm btn-danger delete d-none" onclick="bulkDelete('{{route('sliders.bulkDelete')}}')"><i class="fas fa-trash-alt"></i>
                            Delete</a> --}}
                        </div>
                    </div>
                    <!--end::Header-->
                    ...
                    <div class="card-body pt-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input delete-checkbox" type="checkbox" name="id" value="{{$slider->id}}" />
                        </div>
                        </td>
                        <!--end::Checkbox--> --}}
                        <td>{{$slider->slug}}</td>
                        ...
                        <td>
                            ...
                            <img class="img-fluid" width="35" width="35" src="{{asset('storage/slider_images/150x150/')}}/{{$slide->image}}" alt="{{$slide->image}}" />
                            @endforeach
                            @else
                            N/A
                            @endif
                        ...
                        <td>
                            <a href="javascript:void(0);" class="badge badge-light-{{$slider->status == " 1" ? "success" : "danger"}}" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark"
                                data-bs-placement="top" title="{{$slider->status == " 1" ? "Active" : "Inactive"}}"
                                onclick="updateStatus('{{route('sliders.update-status', ['id' => $slider->id])}}', '{{$slider->status}}', false)">
                                {{$slider->status == "1" ? "Active" : "Inactive"}}
                            </a>
                        </td>
                        <td>
                            @can('Edit-Sliders')
                            <a href="{{route('sliders.edit', ['id' => $slider->id])}}" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-bs-toggle="tooltip"
                            ...
                            {{-- @can('Delete-Sliders')
                                            <a href="javascript:void(0);" class="btn btn-icon btn-active-light-primary w-30px h-30px"
                                                onclick="deleteData('{{route('sliders.delete', ['id' => $slider->id])}}', false)" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark"
