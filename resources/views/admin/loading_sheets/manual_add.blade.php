                                ...
                                @if (count($item_all))
                                    @can('Add-Loading-Sheets')
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal"
                                            data-bs-target="#add-item"><i class="fas fa-plus-circle"></i> Add new item</button>
                                        </button>
                                                ...
                                                @if (count($item_all) > 0)
                                                    ...
                                                    @foreach ($item_all as $loading_sheet_item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            @php 
                                                              $route = route('loading-sheets.deleteSingleLoadingSheetItem', ['item_id' => $loading_sheet_item['id']]);
                                                            @endphp
                                                            <td class="text-center">
                                                                <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-active-light-primary"
                                        onclick='deleteData("{{$route}}",false)' data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark"
