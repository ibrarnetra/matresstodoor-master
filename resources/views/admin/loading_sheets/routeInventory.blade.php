                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="generic-datatable"
                                            class="table table-striped table-sm gy-2 gs-2 align-middle">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                @if (count($products) > 0)
                                                    ...
                                                    @foreach ($products as $product)
                                                        ...
                                                        <tr>
                                                            <th><b>{{ $product['product_name'] }}<br>{{ $product['option_name'] }}</b>
                                                            </th>

                                                            <th>{{ isset($inventories[$product['product_id']][$product['option_id']]['delivered']) ? $inventories[$product['product_id']][$product['option_id']]['delivered'] : '0' }}
                                                            </th>
                                                            <th>{{ isset($inventories[$product['product_id']][$product['option_id']]['return']) ? $inventories[$product['product_id']][$product['option_id']]['return'] : '0' }}
                                                            </th>
                                                            <th>{{ isset($inventories[$product['product_id']][$product['option_id']]['pending']) ? $inventories[$product['product_id']][$product['option_id']]['pending'] : '0' }}
                                                            </th>
