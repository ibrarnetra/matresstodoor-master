                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-1 mb-5 pb-3 pt-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="{{route('loading-sheets.create')}}" class="btn btn-sm btn-primary create"><i class="fas fa-plus-circle"></i> Create New</a>
                            @endcan --}}
                            {{-- <a href="javascript:void(0);" class="btn btn-sm btn-danger delete d-none" onclick="bulkDelete('{{route('loading-sheets.bulkDelete')}}')"><i
                    ...
                    <div class="card-body pt-0">
                                    ...
                                    <table id="generic-datatable" class="table table-striped table-sm gy-2 gs-2 align-middle">
                                        <thead>
                                            <tr class="fw-bolder fs-6 text-gray-800">
                                                ...
                                                <th style="width: 43%">Created By</th>
                                                <th style="width: 7%">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @if(count($loading_sheets) > 0)
                                            @php $a = 0 @endphp
                                            @foreach ($loading_sheets as $loading_sheet)
                                            @php $a++ @endphp
                                            <tr>
                                                <td>{{$a}}</td>
                                                <td>{{$loading_sheet->name}}</td>
                                                <td>{{$loading_sheet->created_by_user->first_name . " " . $loading_sheet->created_by_user->last_name}}</td>
                                                <!--begin::Action=-->
                                                <td class="text-end">
                                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm d-flex" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-2"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a class="menu-link px-3" href="{{route('loading-sheets.detail', ['id' => $loading_sheet->id])}}">
                                                                <i class="far fa-eye me-2"></i> Detail</a>
                                                        </div>
                                                        <!-- end::Menu item-->
                                                      
                                                        <!--begin::Menu item-->
                                                        @can('Delete-Loading-Sheets')
                                                        <div class="menu-item px-3">
                                                            <a class="menu-link px-3" href="javascript:void(0);"
                                                                onclick="deleteData('{{route('loading-sheets.delete', ['id' => $loading_sheet->id, 'type' => 'loading-sheet'])}}', false)">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {{$loading_sheets->links('admin.pagination.pagination')}}
                            </div>
                        </div>
                    </div>
                </div>
