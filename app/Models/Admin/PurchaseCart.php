...
class PurchaseCart extends Model
{
    ...
    function _store($product_id, $warehouse_id, $product_qty, $options,$price)
    {
    ...
    {
        Cart::where('id', $cart_id)->update(['quantity' => $updated_qty]);
    ...
    function _all($warehouse_id)
    {
        ...
        ])->where('warehouse_id', $warehouse_id)->get()->toArray();
    }
